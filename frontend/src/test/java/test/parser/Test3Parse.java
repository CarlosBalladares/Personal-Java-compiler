...
public class Test3Parse {
    ...
    // Extension Tests
    /**
     *     Extension 1 Arithmetic and relational operators:
     *     Relational ops
     *     - equals
     *     - or
     *     - lessthan or equals
    ...
    // Optional test just to check if the parse can handle extreme cases
    @Test
    public void weirdParsing() throws Exception {
        accept("class Main {\n" +
                "  public static void main(String[] args) {\n" +
                "      System.out.println(args[3+3].length== this.h()[5+5].hello( a,ff.ee()[6], (new int[5]).er().length));\n" +
                "  }\n" +
                "}"
        );
    }
...
//        //This test is just a copy of the ObjectPassing.java
//        //file and has been put here for faster debugging
//        accept("class ArrayPassing {\n" +
//                "    public static void main(String[] args) {\n" +
