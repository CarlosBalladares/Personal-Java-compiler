...
public abstract class Word {
    ...
    public boolean isGT(Word other) {
        throw new Error("greaterThan -- not supported for " + this + " " + other);
    }
    public boolean isGE(Word other) {
        throw new Error("greaterOrEqualTo -- not supported for " + this + " " + other);
    }
    public boolean isLE(Word other) {
        throw new Error("lesserOrEqualTo -- not supported for " + this + " " + other);
    }
