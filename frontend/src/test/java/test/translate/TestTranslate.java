...
//				"      System.out.println(903);\n" +
    ...
    @Test
    public void printRelopAnd() throws Exception {
        test("0\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
    ...
    @Test
    public void printRelopEquals() throws Exception {
        test("0\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
    ...
    @Test
    public void printRelopOr() throws Exception {
        test("1\n1\n1\n0\n5\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
    ...
    @Test
    public void printRelopGreater() throws Exception {
        test("0\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
    ...
    @Test
    public void printRelopGreaterEqual() throws Exception {
        test("0\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
                "      System.out.println(5>=6);\n" +
                "  }\n" +
    ...
    @Test
    public void printRelopSmallerEqual() throws Exception {
        test("1\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
                "      System.out.println(5<=6);\n" +
                "  }\n" +
    ...
    @Test
    public void printRelopNotEquals() throws Exception {
        test("1\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
                "      System.out.println(5!=6);\n" +
                "  }\n" +
    ...
    @Test
    public void moreNullObjects() throws Exception {
        test("0\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
                "      System.out.println(new Test() == null);\n" +
                "  }\n" +
    ...
    @Test
    public void objectNullEquality() throws Exception {
        test("0\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
                "      System.out.println(new Test()== null);\n" +
                "  }\n" +
                ...
                "       t=null;" +
                "       t= new Test();\n" +
                "      if (t==t) System.out.println(99); else {}\n" +
                "      return 9999;\n" +
                "  }\n" +
                "}");
    }
    @Test
    public void objectNullInequality() throws Exception {
        test("1\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
                "      System.out.println(new Test()!= null);\n" +
                "  }\n" +
    ...
    @Test
    public void objectObjectInequality() throws Exception {
        test("0\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
    ...
    @Test
    public void objectObjectInequality2() throws Exception {
        test("5\n1\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
    ...
    @Test
    public void assignedObjects() throws Exception {
        test("0\n","class Main {\n" +
                "  public static void main(String[] args) {\n" +
                "      System.out.println(new Test().test());\n" +
                "  }\n" +
...
//        test("1\n","class Main {\n" +
//                "  public static void main(String[] args) {\n" +
//                "      System.out.println(new Test().test(false));\n" +
//                "  }\n" +
//                "}\n" +
//                "class Test {\n" +
//                "  public int test(boolean flag) {\n" +
//                "       Test t1;\n" +
//                "       Test t2;t1=new Test();t2=null;\n" +
//                "       if(t1==t2){System.out.println(0);}else{}" +
//                "       t2=null;" +
//                "       if(t1==t2){System.out.println(1);}else{}" +
//                "       t2=new Test();t1=new Test();" +
//                "       if(t1==t2){System.out.println(1);}else{}" +
//                "       return 1;\n"+
//                "  }\n" +
//                "}");
//    }
    ...
    public void testSuper() throws Exception {
        ...
        for (int i = 0; i < files.length; i++) {
            File f = files[i];
            if (f.toString().equals("sample/super.java"))
                test(f);
        }
    }
    ...
    public void failingTest() throws Exception {
        ...
        for (int i = 0; i < files.length; i++) {
            File f = files[i];
            if (f.toString().equals("sample/const.java"))
                test(f);
        }
    }
