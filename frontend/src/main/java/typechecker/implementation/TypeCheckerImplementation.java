...
public class TypeCheckerImplementation extends TypeChecked {
     ...
     */
    private ImpTable<Pair<ImpTable<Type>, ImpTable<Type>>> variables;
     ...
     */
    public ImpTable<Pair<ImpTable<Type>, ImpTable<Type>>> buildTable() {
        variables = program.accept(new BuildSymbolTableVisitor(errors));
        return variables;
    }

    public ImpTable<Pair<ImpTable<Type>, ImpTable<Type>>> typeCheckPhaseTwo() throws TypeCheckerException {
        program.accept(new TypeCheckVisitor(variables, errors));
        errors.close();
        return variables;
    }
    ...
    public ImpTable<Pair<ImpTable<Type>, ImpTable<Type>>> getTable() {
        return variables;
    }
