...
//        expect( typeError()
    ...
    @Test public void goodFunctionDeclaration() throws Exception {
        ...
        //Expects x to be bool but x is int, local overwriting the global
        ...
        accept(progWithFunction("int x(){return 3;}\nint a(){return 5;}"));
        //test assigment after/before function
        accept(progWithFunction("int x(){return 3;}\na=4;"));
        accept(progWithFunction("a=8;\nint x(){return 3;}\n"));
        //test assignments within scope of function
        accept(progWithFunction("int x(){s=3;\nreturn 3;}\n"));
        //test assignment of varwith same name outside function
        accept(progWithFunction("int x(){s=3;\nreturn 3;}\ns=4;"));
        //test assign var with function
        //This should not pass since we can only assign integers to values using =, not functions
        //accept(progWithFunction("int x(){s=3;\nreturn 3;}y=x();"));
