 ...
 * @author kdvolder
 */
public class MyTypeCheckTest extends Test4Parse{
...
//    }
    ...
    @Override
    protected void accept(File file) throws TypeCheckerException, Exception {
        TypeChecker.parseAndCheck(file);
    }

    @Override
    protected void accept(String string) throws TypeCheckerException, Exception {
